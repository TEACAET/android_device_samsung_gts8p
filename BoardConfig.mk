...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/gts8p/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/gts8p/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/gts8p/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPUH24B001"
